...
class OutputGetBlockByNumber {
     ...
     * @param {module:model/OutputGetBlockByNumber} obj Optional instance to populate.
     * @return {module:model/OutputGetBlockByNumber} The populated <code>OutputGetBlockByNumber</code> instance.
     */
