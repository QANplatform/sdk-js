...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QanAutoApi.InputSubscribe();
  });
  ...
  describe('InputSubscribe', function() {
    it('should create an instance of InputSubscribe', function() {
      // uncomment below and update the code to test InputSubscribe
      //var instance = new QanAutoApi.InputSubscribe();
      //expect(instance).to.be.a(QanAutoApi.InputSubscribe);
    });
